...
import com.decibel.civilianc2.radios.DRA818V;
...
public class ConfigureRadioTVDisplay extends Activity implements AdapterView.OnItemSelectedListener, DRA818V.IEventListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_configure_transceiver);
        String driver = getIntent().getStringExtra("radio.driver");

        radio = RadioDriverFactory.getInstance().getTransceiver(driver);
    ...
    public void onFrequencyChanged(final int rx, final int tx, int sql) {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                txtTxFreq.setText(String.format("%.3f", t));
                txtRxFreq.setText(String.format("%.3f", r));
            }
        });
